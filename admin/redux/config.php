<?php
  ...
  //  $args['admin_bar_links'][] = array(
   ...
   // );
    ...
    $args['footer_text'] = __( '<p>This Theme Option is proudly developed by Digital Media Company</p>', 'redux-framework-demo' );
    ...
    Redux::setSection( $opt_name, array(
        ...
        array(
                ...
                'subtitle'     => __( 'Upload Phone Number', 'redux-framework-demo' ),
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type'        => 'typography',
                'title'       => __( 'Typography h1.site-description', 'redux-framework-demo' ),
                ...
                'compiler'    => array( 'h1.site-description-compiler' ),
                // An array of CSS selectors to apply this font style to dynamically
                'units'       => 'px',
                // Defaults to px
    ...
    Redux::setSection( $opt_name, array(
        ...
        Redux::setSection( $opt_name, array(
        'title'      => __( 'Background', 'redux-framework-demo' ),
        'id'         => 'design-background2',
        'subsection' => true,
        'fields'     => array(
            array(
                'id'       => 'opt-background2',
                'type'     => 'background',
                'output'   => array( '.error-bg' ),
                'title'    => __( 'Body Background', 'redux-framework-demo' ),
                'subtitle' => __( 'Body background with image, color, etc.', 'redux-framework-demo' ),
                'default'   => '#000',
            ),
...
// SOCIAL
    Redux::setSection( $opt_name, array(
        ...
        'id'     => 'social',
        'desc'   => __( 'From here you can change social links of your website.', 'redux-framework-demo' ),
        'icon'   => 'el el-globe',
        'fields' => array(
			array(
                'id'       => 'social-twitter',
			...
			array(
                ...
                'subtitle'     => __( 'Update Tumblr link on your website.', 'redux-framework-demo' ),
            ),
            array(
                'id'       => 'social-facebook',
                'type'     => 'text',
             ...
             array(
                ...
                'subtitle'     => __( 'Update Whatsapp link on your website.', 'redux-framework-demo' ),
            ),
             array(
                'id'       => 'social-mail',
                'type'     => 'text',
                'title'    => __( 'Mail ', 'redux-framework-demo' ),
                'subtitle'     => __( 'Update Mail link on your website.', 'redux-framework-demo' ),
            ),
             array(
                'id'       => 'social-circle',
                'type'     => 'text',
                'title'    => __( 'Circle ', 'redux-framework-demo' ),
                'subtitle'     => __( 'Update Circle link on your website.', 'redux-framework-demo' ),
            ),
               array(
                'id'       => 'social-skype',
                'type'     => 'text',
                'title'    => __( 'Skype ', 'redux-framework-demo' ),
                'subtitle'     => __( 'Update Skype link on your website.', 'redux-framework-demo' ),
            ),
        )
    ) );
   ...
   Redux::setSection( $opt_name, array(
        ...
        'id'     => 'home-page',
        'desc'   => __( 'From here you can change Home Page of your website.', 'redux-framework-demo' ),
        'icon'   => 'el el-home',
        'fields' => array(
            array(
                'id'       => 'home-page-banner-text',
                'type'     => 'editor',
                'title'    => __( 'Home Page Banner Text', 'redux-framework-demo' ),
                'subtitle'     => __( 'Edit Home Page Banner Text for your website.', 'redux-framework-demo' ),
                 'args'    => array(
                    'wpautop'       => false,
                    'media_buttons' => false,
                    'textarea_rows' => 5,
             ...
             array(
                ...
                'subtitle'     => __( 'Upload Banner for your website.', 'redux-framework-demo' ),
            ),
...
// CSS EDITER
   ...
   Redux::setSection( $opt_name, array(
        'title'  => __( 'Code Editer', 'redux-framework-demo' ),
        'id'     => 'code-editer',
        'desc'   => __( 'From here you can change Home Page of your website.', 'redux-framework-demo' ),
        'icon'   => 'el el-home',
        'fields' => array(
